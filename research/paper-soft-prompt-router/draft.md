...
Our contributions:
- A systematic ablation across four edge models (gemma-3-1b-it, gemma-4-E2B, gemma-4-E4B, gemma-4-E4B-it) paired with gemma-4-26B-A4B-it as cloud, evaluated on 100 prompts across 7 domains
...
We evaluate on 100 prompts across 7 domains: geography (20), science (15), math (15), literature (10), history (10), translation (10), creative (10), reasoning (10). Metrics:
